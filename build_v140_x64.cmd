...
cmake -G Ninja ^
      ...
      -D ZLIB_BUILD_SHARED_LIBS:BOOL=OFF ^
      -D GFLAGS_BUILD_SHARED_LIBS:BOOL=OFF ^
      -D GLOG_BUILD_SHARED_LIBS:BOOL=OFF ^
      -D HDF5_BUILD_SHARED_LIBS:BOOL=OFF ^
      -D HDF5_LIB_PREFIX:STRING=caffe ^
      -D BOOST_BUILD_SHARED_LIBS:BOOL=OFF ^
      ...
      -D OPENBLAS_BUILD_SHARED_LIBS:BOOL=OFF ^
